...
* epistle written with his hand and found sealed up
...
"`And now, all heavenly Jerusalem`'s and Zion`'s children, that are from above,
...
But debate, strife, willfulness, and laying open one another`'s nakedness and weakness,
...
but all that old leaven, which makes people`'s hearts sour, and burn one against another,
...
Isaiah saith, '`The Redeemer shall come to Zion,`' etc., Isa. 59:20. And,
...
hammer down, and burn up all the strongholds of Satan.
...
he is not likely to clothe them with his fine linen,
...
I went to Tottenham; and some time after to Ford-Green;
at which places I continued several weeks,
visiting Friends`' meetings round about there,
...
My desires are, that all may fulfill their ministry,
...
and others, assembled at the meetinghouse in White-Hart-Court, near Gracechurch Street,
