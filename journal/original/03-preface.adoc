...
but through the subtlety of the serpent (that had first fallen from his own state),
...
"`and make no more provision for the flesh, to fulfill the lusts thereof.`"
...
and that while mourning is fit for a Christian to have,
...
for now thy poor servants hear? O! that thy will may be done, thy great,
...
O land of my nativity! I have mourned over thee with bitter wailing and lamentation.
...
footnote:[They are thus particularized in a more recent publication
...
and as he took most delight in sheep, so he was very skillful in them;
...
see the subtlety of the enemy to rend and divide,
...
or not fit match for every service or occasion.
...
recommending to some with him, the dispatch and dispersion of an epistle,
...
to which others were continually exposed from the prevalency of the lust of the eye,
...
that are in the exercise of the ministry: Oh, feel Life in your ministry!
...
Jesus loved and chose solitudes; often going to mountains, to gardens, and seasides,
