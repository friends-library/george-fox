...
for ho was indeed a cheat, and had cheated a priest by pretending to be a minister;
...
Ho told the king that "`if he would be pleased to give liberty of conscience,
