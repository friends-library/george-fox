...
--
//Not sure where the footnote ends in this either. 
...
`    "`Early believers in the light of Truth
     ...
     // ^^ Does this need to be formatted differently?
...
//THis above shouldn't be embedded, shoul it? Since it's a prayer? but it's signed!