...
Read this over, it concerns thy general good,
and all the Powers that be under thee,
which are suitable things to this present age.--By G. F.
...
and Christ said false prophets should come, Matt. 7. and Matt. 24.
and antichrist which had the sheep`'s clothing, but inwardly ravening wolves;
...
Rev. 11. and the dragon made war with the woman, the true church,
