[.style-blurb, short="Several Plain Truths Manifested"]
...
'`And Jesus walked by the seaside of Galilee, and saw two brethren, Simon called Peter,
...
and followed him.`' Here did not Christ preach by the seaside of Galilee,
...
And again in Mark 4. Christ begins to teach by the seaside,
and there were gathered unto him a great multitude, so that he entered into a ship,
and sat in the ship on the seaside, and the whole multitude was by the sea on the land,
and he taught them many things,`' etc.
Here you may see again Christ taught by the seaside in a ship.
